...
\
The final cleaned and grouped data set was also stored in `.RData` format to facilitate analysis in R.\
You can download the file from our repository using the link below:\
[Download the cleaned dataset file in .RData format](#).
