...
data_yusuf <- data_yusuf[, c("DATE", "CPI", "IR", "CCI")]
...
Correlation value is 0.638 which means these two indicators has a moderatly strong relation.Also p-value is less than 0.05 and this indicates this correlation value is significantly meaningfull.To conclude,we can say PPI and Interest Rate indicators can affects each other moderatly.
...
0.326 is too low to say these indicators has a notable relation and also p-value is low enough to be statisticaly meaningful but it is lower than our other correlation p-values.So we can easily say we can not confirm that there is a strong relation bewteen PPI and CCI.
...
• Interest Rates- Producer Price Index (PPI)= : 0.63844

• Consumer Confidence Index- Producer Price Index (PPI)= 0.32652
...
correlations <- c(0.7959363, 0.88859, 0.63844,0.30305)
